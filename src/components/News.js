...
const News = (props) => {
    ...
    useEffect(() => {
        document.title = `${capitalizeFirstLetter(props.category)} - Saurabh Media`;
        updateNews();
    ...
    return (
        <>
            <h1 className="text-center" style={{ margin: '35px 0px', marginTop: '90px' }}>Saurabh Media - Top {capitalizeFirstLetter(props.category)} Headlines</h1>
            {loading && <Spinner />}
            <InfiniteScroll
